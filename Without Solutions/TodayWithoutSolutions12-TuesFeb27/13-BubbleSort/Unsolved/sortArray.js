...
for(var q = 0; q < unsortedArr.length; q++) {
  // below for loop is to select a number in the array when it passes by 
  for(var w = 0; w < nums.length; w++){
    //compare number to swap the below
    

  }
}
// 2 variables created after 
 //them will compare any repairs 
//last one will imit the loop 
